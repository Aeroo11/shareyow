...
/**
 * Anon key memang dirancang untuk ditanam di aplikasi klien dan terlihat siapa
 * pun — yang menjaga data bukan kerahasiaannya, melainkan Row Level Security di
 * sisi basis data. Yang tidak boleh masuk ke sini, ke .env, atau ke mana pun
 * dekat kode klien adalah `service_role` key: ia melewati seluruh RLS.
 */
export const CONFIG_HELP =
  'Salin .env.example menjadi .env, lalu isi EXPO_PUBLIC_SUPABASE_URL dan ' +
  'EXPO_PUBLIC_SUPABASE_ANON_KEY dari Settings → API di dasbor Supabase.';
